...
<script setup>
    ...
    // Sample stock data
    const stocks = [
        { symbol: 'AAPL', name: 'Apple Inc.', price: 178.20 },
        { symbol: 'MSFT', name: 'Microsoft Corp.', price: 312.55 },
        { symbol: 'GOOGL', name: 'Alphabet Inc.', price: 125.90 },
        { symbol: 'AMZN', name: 'Amazon.com Inc.', price: 132.45 },
        { symbol: 'TSLA', name: 'Tesla Inc.', price: 187.75 },
        { symbol: 'NVDA', name: 'NVIDIA Corp.', price: 408.15 }
    ];
